  ...
  return (
    <div className='border border-b-black/20 '>
      ...
      <div className='bg-white py-6'>
        <div className='container'>
          <nav className='flex flex-wrap justify-between  lg:justify-around'>
            <Link to={path.home} className='flex flex-wrap '>
              <div>
                <img
              ...
              <div className='text-sm text-orange lg:text-xl'> Giỏ Hàng</div>
            </Link>
